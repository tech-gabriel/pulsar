...
/// <summary>Resultado bruto de geocoding, independente do provedor.</summary>
public record EnderecoGeocodificado(string Descricao, double Latitude, double Longitude);
