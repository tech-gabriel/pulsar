...
public class GatilhoBriefingDiario : IGatilhoNotificacao
{
        ...
        ContextoGatilho ctx, CancellationToken ct = default)
    {
        ...
        // A janela mais chuvosa das próximas 24h, se houver alguma com chuva. O filtro por
        // ChuvaMm > 0 é o que impede a frase de inventar chuva num dia seco: sem ele o
        // MaxBy devolveria a primeira faixa de 0 mm e o resumo anunciaria "0 mm".
        // Em empate o MaxBy fica com a primeira da sequência, e o contexto entrega as
        // faixas em ordem crescente, então o empate escolhe a mais próxima, que é a útil.
        var maisChuvosa = ctx.Previsao
