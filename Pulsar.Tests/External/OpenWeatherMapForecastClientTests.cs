...
public class OpenWeatherMapForecastClientTests
{
    ...
    // O instante vem de `dt` (Unix UTC); `dt_txt` é hora local do payload e não é lido.
    ...
    public void ParseForecast_ConverteDtParaInstanteUtc()
    {
        ...
        // 1755450000 em Unix UTC. O Kind precisa ser Utc: o Npgsql recusa Local ou
        // Unspecified ao gravar em timestamptz, e o SQLite dos testes aceitaria qualquer um.
        ponto.InstantePrevisto.Should().Be(new DateTime(2025, 8, 17, 17, 0, 0, DateTimeKind.Utc));
